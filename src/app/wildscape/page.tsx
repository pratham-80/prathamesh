...
export default function WildscapePage() {
  const project = getProjectBySlug("wildscape");
  ...
  const caseStudies = [
    {
      ...
      href: "https://www.behance.net/gallery/194098871/WildScape-Photography-UI-UX-Case-Study",
      alt: "Wildscape case study cover image",
    },
  ];
