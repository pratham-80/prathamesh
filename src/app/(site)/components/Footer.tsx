...
export default function Footer() {
  return (
    <footer className="mt-24 border-t border-[oklch(0.9_0_0)]">
      <div className="mx-auto max-w-6xl w-full px-4 sm:px-6 py-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between text-sm text-[oklch(0.35_0_0)]">
        <p>© {new Date().getFullYear()} Prathamesh Ingale</p>
        <div className="flex items-center gap-4">
          <a href="https://www.linkedin.com/in/prathamesh-ingale/" target="_blank" rel="noreferrer" className="hover:text-[#1E65ED] transition-colors">
            <Linkedin size={20} />
          </a>
          <a href="https://www.behance.net/prathameshingale" target="_blank" rel="noreferrer" className="hover:text-[#1E65ED] transition-colors">
          ...
          <a href="https://www.instagram.com/i.prathammm/" target="_blank" rel="noreferrer" className="hover:text-[#1E65ED] transition-colors">
            <Instagram size={20} />
          </a>
        </div>
      </div>
